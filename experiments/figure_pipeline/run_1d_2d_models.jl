...
# VelWalk1D.SwitchProb() = 0.
# tr = VelWalk1D.gettr()
# println("VelWalk1D trace without sharp velocity change generated.")
# velwalk1d = dir(base, "velwalk1d_novelchange")
# gen = dir(velwalk1d, "Gen")
# VelWalk1D.figures(tr, name -> fig -> VelWalk1D.save(joinpath(gen, to_img_name(name)), fig))
# println("VelWalk1D no velchange Gen figures created.")
...
# println("VelWalk1D no velchange NeuralGenFast figures created.")

# VelWalk1D.ProbEstimates.use_perfect_weights!()
# VelWalk1D.SwitchProb() = 0.15
# tr = VelWalk1D.get_tr_with_sharp_velchange()
# println("VelWalk1D trace with a sharp velocity change generated.")
# velwalk1d = dir(base, "velwalk1d_velchange")
# gen = dir(velwalk1d, "Gen")
# VelWalk1D.figures(tr, name -> fig -> VelWalk1D.save(joinpath(gen, to_img_name(name)), fig))
# println("VelWalk1D velchange Gen figures created.")
# VelWalk1D.ProbEstimates.use_noisy_weights!()
# ngf = dir(velwalk1d, "NeuralGenFast")
# VelWalk1D.figures(tr, name -> fig -> VelWalk1D.save(joinpath(ngf, to_img_name(name)), fig))
# println("VelWalk1D velchange NeuralGenFast figures created.")
