...
# failed: 2,5,7 -- outdated --
# I think the issue may be that at some timesteps, the proposal_probs are getting out of sync
# with the probs actually used to make the spiketrain, and at those steps, the wrong points
# are plotted
