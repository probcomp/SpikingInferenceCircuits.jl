...
function make_anim_spiketrain_fig_and_get_all_L4_with_all_coords(trs_at_each_time, logweights_at_each_time, neurons_to_show_indices=1:10; kwargs...)
    n_particles = length(first(trs_at_each_time))
...
function get_all_L4_with_all_coords(trs_at_each_time, logweights_at_each_time, neurons_to_show_indices=1:10; kwargs...)
    n_particles = length(first(trs_at_each_time))
